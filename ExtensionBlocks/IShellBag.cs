...
namespace ExtensionBlocks
{
    public interface IShellBag
    {
        ...
        /// <summary>
        ///     Used for tracking purposes by end user
        /// </summary>
        int NodeId { get; set; }
        ...
        Utils.ShellBagTypes ShellBagType { get; set; }
        ...
        ///     First explored time
        /// </summary>
        DateTimeOffset? FirstInteracted { get; set; }

        bool HasExplored { get; set; }

        /// <summary>
        ///     First explored time
        /// </summary>
        DateTimeOffset? LastInteracted { get; set; }
